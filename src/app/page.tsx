...
export default function Home() {
  ...
  return (
    <>
      <main className="min-h-screen px-10 pb-10 ">
        <Header />
        <div className="mx-auto px-20 pt-10">
          ...
          <section className="flex">
            <div className="relative flex-[2] h-[480px] rounded-2xl bg-secondary p-7 mr-7 mb-7">
              <div className="flex h-full flex-col justify-between">
                ...
                <div className="flex flex-col items-start justify-between gap-8">
                  ...
                  <Image
                    src={NoteImage}
                    alt=""
                    className="absolute bottom-35 right-115 w-[150px]"
                  />

                  <Image
                    src={RobotImage}
                    alt="면접 준비 캐릭터"
                    className="absolute bottom-[-25px] right-12 w-[450px]"
                    priority
                  />
                </div>
              </div>
            ...
            <div className="flex-1 h-[480px] rounded-2xl bg-secondary overflow-hidden">
          ...
          <section className="rounded-2xl bg-secondary p-7">
            <div className="flex h-full">
              ...
              <div className="hidden lg:flex w-8 justify-center pt-[80px]">
